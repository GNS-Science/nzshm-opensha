...
public class NZSHM22_SlipRateInversionConstraintBuilderTest {
    ...
    public final static double DELTA = 0.00000000000001;
    ...
    public void testTranslate() {
        ...
        assertEquals(5.5, NZSHM22_SlipRateInversionConstraintBuilder.translate(3.5, 3, 4, 5, 6), DELTA);
    }
    ...
    public void testCreateSectSlipRates(){
        ...
        SectSlipRates actual = NZSHM22_SlipRateInversionConstraintBuilder.createSectSlipRates(original, 2);
