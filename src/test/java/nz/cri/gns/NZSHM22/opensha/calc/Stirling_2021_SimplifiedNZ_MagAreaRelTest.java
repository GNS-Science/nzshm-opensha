...
public class Stirling_2021_SimplifiedNZ_MagAreaRelTest {
    ...
    public void testAdapter() throws IOException {
        ...
        Stirling_2021_SimplifiedNZ_MagAreaRel.Adapter adapter =
                new Stirling_2021_SimplifiedNZ_MagAreaRel.Adapter();

        Stirling_2021_SimplifiedNZ_MagAreaRel original =
                new Stirling_2021_SimplifiedNZ_MagAreaRel(42, "CRUSTAL", "MEAN");
