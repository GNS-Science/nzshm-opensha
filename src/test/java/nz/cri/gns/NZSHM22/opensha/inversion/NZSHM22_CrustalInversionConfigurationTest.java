...
public class NZSHM22_CrustalInversionConfigurationTest {
    ...
    public void testRegions() throws IOException, DocumentException {
        ...
        assertEquals(List.of(true, true, true), Stream.of(5, 6, 7).map(tvzData::isInRegion).collect(Collectors.toList()));
        assertEquals(List.of(true, true, true, true, true), Stream.of(0, 1, 2, 3, 4).map(sansTvzData::isInRegion).collect(Collectors.toList()));
