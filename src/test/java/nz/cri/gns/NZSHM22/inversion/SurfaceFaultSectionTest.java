...
public class SurfaceFaultSectionTest {
    ...
    */
    ...
    // 	RuptureSurface stirling_gridded = fs0.getStirlingGriddedSurface(grid_disc); //, false,
    // false);
    ...
    // 	assertTrue("stirling_gridded.aveDip == fsd.aveDip", stirling_gridded.getAveDip() ==
    // fs0.getAveDip());
    // }
    ...
    // 	assertTrue("quad_gridded.aveDip == fsd.aveDip", quad_gridded.getAveDip() ==
    // fsd0.getAveDip());
    // }
}
