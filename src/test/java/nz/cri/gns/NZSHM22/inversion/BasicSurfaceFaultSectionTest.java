...
public class BasicSurfaceFaultSectionTest {
    ...
    public void testFsdAsStirlingGriddedSurface() {
        ...
        RuptureSurface stirling_gridded =
                fsd0.getStirlingGriddedSurface(grid_disc); // , false, false);
        ...
        assertTrue(
                "stirling_gridded.aveDip == fsd.aveDip",
                stirling_gridded.getAveDip() == fsd0.getAveDip());
    }
    ...
    public void testFsdAsQuadSurface() {
        ...
        assertTrue(
                "quad_gridded.aveDip == fsd.aveDip", quad_gridded.getAveDip() == fsd0.getAveDip());
    }
}
