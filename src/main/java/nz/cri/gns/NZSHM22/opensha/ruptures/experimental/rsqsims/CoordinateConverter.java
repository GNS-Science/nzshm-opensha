 ...
 *
 * <p>Implementing classes need to set the operation property and implement toSourcePosition().
...
public abstract class CoordinateConverter {
    ...
    public Location toWGS84(double easting, double northing, double elevation) {
        try {
            ...
            throw new RuntimeException(
                    this + " could not transform " + easting + ", " + northing, x);
        }
    }
    ...
    /** Converts New Zealand Transverse Mercator coordinates to WGS84 https://epsg.io/2193 */
