 ...
 *
 * <p>See ThinningStats for the implementation.
 */
public class ThinningReport extends AbstractRupSetPlot {
    final String crustalRupsetFileName;

    /**
     * The report is run on a subduction rupture set. We're side-loading the specified crustal
     * rupture set to work out possible combinations for joint ruptures.
     *
