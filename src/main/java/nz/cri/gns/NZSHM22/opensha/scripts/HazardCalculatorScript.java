...
public class HazardCalculatorScript {
        ...
        Options options =
                new Options()
                        ...
                        .addOption(
                                ...
                                "maxDistance",
                                true,
                                "The maximum distance between site and rupture in km")
                        ...
                        .addOption(
                                ...
                                "linear",
                                true,
                                "whether the hazard curve is linear, must be 'true' or 'false'");
    ...
    public static void main(String[] args) throws ParseException, IOException, DocumentException {
        ...
        NZSHM22_HazardCalculatorBuilder builder =
                new NZSHM22_HazardCalculatorBuilder()
        ...
        System.out.println(
                calculator.calc(
                        Double.parseDouble(cmd.getOptionValue("lat")),
