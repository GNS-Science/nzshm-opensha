...
public class PythonGatewayRunner {
    ...
    public static void main(String[] args) throws DocumentException, IOException {
        ...
        ((NZSHM22_PythonGateway.CachedCrustalInversionRunner)
                        runner.setMaxMags("FILTER_RUPSET", 10, 7.5)
                                .setMinMags(6.8, 6.5)
        ...
        //    	/**
        //    	 * classical SA cooling schedule (Geman and Geman, 1984) (slow but ensures
        // convergence)
        //    	 */
        //    	CLASSICAL_SA,
        //    	/**
        ...
        //    	 */
        //    	VERYFAST_SA,
        //    	LINEAR; // Drops temperature uniformly from 1 to 0.  Only use with a completion
        // criteria of a fixed number of iterations.
        runner.setCoolingSchedule("FAST_SA")
