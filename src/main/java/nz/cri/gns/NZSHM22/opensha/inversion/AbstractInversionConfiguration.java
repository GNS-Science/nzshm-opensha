...
public class AbstractInversionConfiguration implements XMLSaveable {
    ...
    public AbstractInversionConfiguration setInversionTargetMfds(
            InversionTargetMFDs inversionTargetMfds) {
    ...
    public AbstractInversionConfiguration setMagnitudeEqualityConstraintWt(
    ...
    public AbstractInversionConfiguration setMagnitudeUncertaintyWeightedConstraintWt(
    ...
    public AbstractInversionConfiguration setSlipRateConstraintWt_normalized(
    ...
    public AbstractInversionConfiguration setSlipRateConstraintWt_unnormalized(
    ...
    public AbstractInversionConfiguration setSlipRateWeightingType(
    ...
    public AbstractInversionConfiguration setSlipRateUncertaintyConstraintWt(
    ...
    public AbstractInversionConfiguration setSlipRateUncertaintyConstraintScalingFactor(
            double slipRateUncertaintyConstraintScalingFactor) {
        this.slipRateUncertaintyConstraintScalingFactor =
                slipRateUncertaintyConstraintScalingFactor;
        return this;
    }
     ...
     * @return
     */
    public AbstractInversionConfiguration setUnmodifiedSlipRateStdvs(
    ...
    public AbstractInversionConfiguration setMinimumRuptureRateBasis(
    ...
    public AbstractInversionConfiguration setNucleationMFDConstraintWt(
    ...
    public AbstractInversionConfiguration setMfdEqualityConstraints(
    ...
    public AbstractInversionConfiguration setMfdUncertaintyWeightedConstraints(
    ...
    public AbstractInversionConfiguration setMinimumRuptureRateFraction(
    ...
    public Element toXMLMetadata(Element root) {
        ...
        el.addAttribute(
                "slipRateConstraintWt_normalized", getSlipRateConstraintWt_normalized() + "");
        el.addAttribute(
        ...
        el.addAttribute(
                "magnitudeInequalityConstraintWt", getMagnitudeInequalityConstraintWt() + "");
        //		el.addAttribute("rupRateConstraintWt", rupRateConstraintWt+"");
        //		el.addAttribute("participationSmoothnessConstraintWt",
        // participationSmoothnessConstraintWt+"");
        //		el.addAttribute("participationConstraintMagBinSize",
    ...
    private static void mfdsToXML(Element el, List<IncrementalMagFreqDist> constraints) {
        ...
        for (int i = 0; i < subEls.size(); i++) subEls.get(i).addAttribute("index", i + "");
    }
}
