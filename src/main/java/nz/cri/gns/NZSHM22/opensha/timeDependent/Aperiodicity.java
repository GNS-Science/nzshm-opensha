...
public enum Aperiodicity {
    ...
    private double[]
            aperMagBoundariesArray; // the magnitude boundaries; must have one less element than the
    // next array
    ...
    /**
     * This is an array of aperiodicity values for the magnitudes ranges defined by what's returned
     * by getAperMagThreshArray().
     *
     * @return
     */
