...
//	EvenlyDiscretizedFunc normBPT_CDF;
	...
	public ProbabilityModelsCalc(FaultSystemSolution fltSysSolution, double[] longTermRateOfFltSysRupInERF, MagDependentAperiodicityOptions magDepAperiodicity) {
		this(fltSysSolution, longTermRateOfFltSysRupInERF, magDepAperiodicity.getAperValuesArray(), magDepAperiodicity.getAperMagBoundariesArray());
	}

	public ProbabilityModelsCalc(FaultSystemSolution fltSysSolution, double[] longTermRateOfFltSysRupInERF, Aperiodicity aperiodicity) {
		this(fltSysSolution, longTermRateOfFltSysRupInERF, aperiodicity.getAperValuesArray(), aperiodicity.getAperMagBoundariesArray());
	}
	 ...
	 * 
	 */
	public ProbabilityModelsCalc(FaultSystemSolution fltSysSolution, double[] longTermRateOfFltSysRupInERF, double[] aperValues, double[] aperMagBoundaries) {
