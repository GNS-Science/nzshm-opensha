...
/**
 * Based on https://gist.github.com/vgrem/73451bd7273d8b5ba949c4d0fb654ec6
 */
...
public class UtmConverter {
     ...
     *               false otherwise.
     */
    public static Location convertToLatLng(double x, double y, int zone, boolean southhemi){
     ...
     */
    private static Location mapPointToLatLng(double x, double y, double lambda0) {
        ...
        return new Location(Math.toDegrees(lat_rad),Math.toDegrees(lng_rad));
    }
