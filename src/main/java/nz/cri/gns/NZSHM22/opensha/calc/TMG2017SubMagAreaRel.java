 ...
 * <p><b>Description:</b>
 *
 * <p>This implements SUBDUCTION specific magnitude versus rupture area relations of Thingbaijam
 * K.K.S., P.M. Mai and K. Goda 2017, Bull. Seism. Soc. Am., 107, 2225–2246.
 *
 * <p>
 *
 * <p>We consider rake to differentiate different broad faulting-types: interface (reverse-faulting)
 * and inslab (normal-faulting). The classification is as follows: Interface (reverse-faulting):
 * Rake angles within 45 to 135, and Inslab (normal-faulting): Rake angles within -45 to -135.
 *
 * <p>Notes: [1] Relations for strike-slip events are not defined. [2] The standard deviation for
 * area as a function of mag is given for log(area) (base-10) not area.
 *
...
public class TMG2017SubMagAreaRel extends MagAreaRelationship {
    ...
    /**
     * Computes the median magnitude from rupture area for previously set rake values that
     * distinguish between interface (reverse) events and inslab normal faulting events .
     *
     * @param area in km
    ...
    /**
     * Computes the median rupture area from magnitude (for the previously set rake and regime
     * values).
     *
    ...
    /**
     * This overrides the parent method to disallow strike-slip faulting type.
     *
     * @param rake
     */
