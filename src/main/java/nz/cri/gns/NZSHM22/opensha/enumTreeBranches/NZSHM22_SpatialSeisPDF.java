...
public enum NZSHM22_SpatialSeisPDF implements LogicTreeNode {
    ...
    FLOOR_ADDOPTIEEPASCOMB_CRU(
            "Floor_AddoptiEEPAScomb-CRU", "hybridEEPAS", "Floor_AddoptiEEPAScomb-CRU_pdf.csv");
    ...
    public static LogicTreeLevel<LogicTreeNode> level() {
        return LogicTreeLevel.forEnumUnchecked(
                NZSHM22_SpatialSeisPDF.class, "NZSHM22_SpatialSeisPDF", "NZSHM22_SpatialSeisPDF");
    }
}
