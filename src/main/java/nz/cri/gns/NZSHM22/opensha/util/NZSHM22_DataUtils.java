...
public class NZSHM22_DataUtils {
    ...
    //
    /**
     * The URL prefix for loading file from the persistent data directory. This MUST have forward
     * slashes as it is for jar file loading. It cannot use File.separator.
     */
    ...
    protected static String getRelativePath(String... pathElements) {
        ...
        for (String pathElement : pathElements)
            if (pathElement != null) relativePath += "/" + pathElement;
        return relativePath;
    }
    ...
    /**
     * This creates an input stream reader for the given input stream. Note that this is NOT
     * buffered, so you should buffer it yourself if needed by wrapping in a buffered stream reader.
     *
     * @param is
     * @return
     * @throws IOException
    ...
    /**
     * This creates an input stream reader for the given URL. Note that this is NOT buffered, so you
     * should buffer it yourself if needed by wrapping in a buffered stream reader.
     *
     * @param url
     * @return
     * @throws IOException
