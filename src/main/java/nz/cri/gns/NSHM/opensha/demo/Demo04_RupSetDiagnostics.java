...
public class Demo04_RupSetDiagnostics {
	...
	public static void main(String[] args) throws IOException, DocumentException {
		...
		File distAzCache = null; // new File(rupSetsDir, "fm3_1_dist_az_cache.csv");
...
//		String compName = "CFM maxJump:3km minSects:2";
//		File compareFile = new File(rupSetsDir, "CFM_crustal_3km_s2_all.zip");
		String compName = "CFM maxJump:1km minSects:5";
		File compareFile = new File(rupSetsDir, "CFM_crustal_1km_s5_all.zip");
		Location loc1 = new Location( -36, 165);
		Location loc2 = new Location( -48, 180);
