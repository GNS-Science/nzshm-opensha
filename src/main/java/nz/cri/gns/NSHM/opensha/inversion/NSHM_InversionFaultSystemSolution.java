...
/**
 * This is a SlipEnabledSolution that also contains parameters used in the
 * NSHM.NZ Inversion
 * 
 * @author chrisbc
 *
...
public class NSHM_InversionFaultSystemSolution extends SlipEnabledSolution {
	...
	/**
	 * Inversion constraint weights and such. Note that this won't include the
	 * initial rup model or target MFDs and cannot be used as input to
	...
	/**
	 * Can be used on the fly for when InversionConfiguration/energies are not
	 * available/relevant
	 * 
	 * @param rupSet
	 * @param rates
	...
	protected void init(NSHM_InversionFaultSystemRuptSet rupSet, double[] rates, UCERF3InversionConfiguration config,
